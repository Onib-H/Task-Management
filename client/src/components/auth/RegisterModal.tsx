            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-3 py-3 bg-gray-50 border-b-2 ${
                    passwordError ? "border-red-400" : "border-gray-200 focus:border-blue-400"
                ...
                <label 
                  ...
                  className={`absolute left-3 transition-all duration-300 pointer-events-none ${
                    isFocused.confirmPassword || confirmPassword 
                      ? `text-xs ${passwordError ? 'text-red-500' : 'text-blue-500'} -top-2` 
                      : 'text-gray-500 top-3'
                  }`}
                >
                  Confirm Password
